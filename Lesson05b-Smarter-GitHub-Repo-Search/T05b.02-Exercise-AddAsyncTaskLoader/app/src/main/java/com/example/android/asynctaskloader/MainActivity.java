    ...
    public android.support.v4.content.Loader<String> onCreateLoader(int i, final Bundle bundle) {
        ...
        return new android.support.v4.content.AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String searchQueyUrlString = bundle.getString(SEARCH_QUERY_URL_EXTRA);
                if (searchQueyUrlString != null || TextUtils.isEmpty(searchQueyUrlString)) {
                    return null;
                }
                try {
                    URL searchUrl = new URL(searchQueyUrlString);
